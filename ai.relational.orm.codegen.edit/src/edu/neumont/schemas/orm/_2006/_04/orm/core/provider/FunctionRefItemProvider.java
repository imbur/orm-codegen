...
/**
 * This is the item provider adapter for a {@link edu.neumont.schemas.orm._2006._04.orm.core.FunctionRef} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FunctionRefItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FunctionRef_ref_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FunctionRef_ref_feature", "_UI_FunctionRef_type"),
				 CorePackage.eINSTANCE.getFunctionRef_Ref(),
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((FunctionRef)object).getRef();
		return label == null || label.length() == 0 ?
			getString("_UI_FunctionRef_type") :
