...
/**
 * This is the item provider adapter for a {@link edu.neumont.schemas.orm._2006._04.orm.diagram.RoleType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RoleTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RoleType_ref_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RoleType_ref_feature", "_UI_RoleType_type"),
				 DiagramPackage.Literals.ROLE_TYPE__REF,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((RoleType)object).getRef();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RoleType.class)) {
			case DiagramPackage.ROLE_TYPE__REF:
