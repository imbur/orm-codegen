...
/**
 * This is the item provider adapter for a {@link edu.neumont.schemas.orm._2006._04.orm.core.ConstraintsType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstraintsTypeItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CorePackage.eINSTANCE.getConstraintsType_Group());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CorePackage.eINSTANCE.getConstraintsType_Group(),
				 FeatureMapUtil.createEntry
					(CorePackage.eINSTANCE.getConstraintsType_SetComparisonConstraint(),
		...
		newChildDescriptors.add
			(createChildParameter
				(CorePackage.eINSTANCE.getConstraintsType_Group(),
				 FeatureMapUtil.createEntry
					(CorePackage.eINSTANCE.getConstraintsType_SetConstraint(),
		...
		newChildDescriptors.add
			(createChildParameter
				(CorePackage.eINSTANCE.getConstraintsType_Group(),
				 FeatureMapUtil.createEntry
					(CorePackage.eINSTANCE.getConstraintsType_ValueConstraint(),
		...
		newChildDescriptors.add
			(createChildParameter
				(CorePackage.eINSTANCE.getConstraintsType_Group(),
				 FeatureMapUtil.createEntry
					(CorePackage.eINSTANCE.getConstraintsType_CardinalityConstraint(),
					 CoreFactory.eINSTANCE.createCardinalityConstraintRef())));
	}
