...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Entity Type Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link edu.neumont.schemas.orm._2006._04.orm.core.impl.EntityTypeTypeImpl#getPreferredIdentifier <em>Preferred Identifier</em>}</li>
 *   <li>{@link edu.neumont.schemas.orm._2006._04.orm.core.impl.EntityTypeTypeImpl#getInstances <em>Instances</em>}</li>
 *   <li>{@link edu.neumont.schemas.orm._2006._04.orm.core.impl.EntityTypeTypeImpl#getExtensions <em>Extensions</em>}</li>
 *   <li>{@link edu.neumont.schemas.orm._2006._04.orm.core.impl.EntityTypeTypeImpl#getReferenceMode <em>Reference Mode</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EntityTypeTypeImpl extends ObjectTypeTypeImpl implements EntityTypeType {
	/**
	...
	protected EClass eStaticClass() {
		return CorePackage.eINSTANCE.getEntityTypeType();
	}
	...
	public NotificationChain basicSetPreferredIdentifier(UniquenessConstraintRef newPreferredIdentifier, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CorePackage.ENTITY_TYPE_TYPE__PREFERRED_IDENTIFIER, oldPreferredIdentifier, newPreferredIdentifier);
	...
	public void setPreferredIdentifier(UniquenessConstraintRef newPreferredIdentifier) {
		if (newPreferredIdentifier != preferredIdentifier) {
			...
			if (preferredIdentifier != null)
				msgs = ((InternalEObject)preferredIdentifier).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CorePackage.ENTITY_TYPE_TYPE__PREFERRED_IDENTIFIER, null, msgs);
			if (newPreferredIdentifier != null)
				msgs = ((InternalEObject)newPreferredIdentifier).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CorePackage.ENTITY_TYPE_TYPE__PREFERRED_IDENTIFIER, null, msgs);
			msgs = basicSetPreferredIdentifier(newPreferredIdentifier, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.ENTITY_TYPE_TYPE__PREFERRED_IDENTIFIER, newPreferredIdentifier, newPreferredIdentifier));
	}
	...
	public NotificationChain basicSetInstances(EntityTypeInstancesType newInstances, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CorePackage.ENTITY_TYPE_TYPE__INSTANCES, oldInstances, newInstances);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setInstances(EntityTypeInstancesType newInstances) {
		if (newInstances != instances) {
			NotificationChain msgs = null;
			if (instances != null)
				msgs = ((InternalEObject)instances).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CorePackage.ENTITY_TYPE_TYPE__INSTANCES, null, msgs);
			if (newInstances != null)
				msgs = ((InternalEObject)newInstances).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CorePackage.ENTITY_TYPE_TYPE__INSTANCES, null, msgs);
			msgs = basicSetInstances(newInstances, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.ENTITY_TYPE_TYPE__INSTANCES, newInstances, newInstances));
	}
	...
	public NotificationChain basicSetExtensions(ExtensionsType newExtensions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CorePackage.ENTITY_TYPE_TYPE__EXTENSIONS, oldExtensions, newExtensions);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setExtensions(ExtensionsType newExtensions) {
		if (newExtensions != extensions) {
			NotificationChain msgs = null;
			if (extensions != null)
				msgs = ((InternalEObject)extensions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CorePackage.ENTITY_TYPE_TYPE__EXTENSIONS, null, msgs);
			if (newExtensions != null)
				msgs = ((InternalEObject)newExtensions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CorePackage.ENTITY_TYPE_TYPE__EXTENSIONS, null, msgs);
			msgs = basicSetExtensions(newExtensions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.ENTITY_TYPE_TYPE__EXTENSIONS, newExtensions, newExtensions));
	}
	...
	public void setReferenceMode(String newReferenceMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.ENTITY_TYPE_TYPE__REFERENCE_MODE, oldReferenceMode, referenceMode));
	}
