...
import edu.neumont.schemas.orm._2006._04.orm.root.*;
...
public class RootAdapterFactory extends AdapterFactoryImpl {
	...
	protected RootSwitch<Adapter> modelSwitch =
		new RootSwitch<Adapter>() {
			...
			@Override
			public Adapter caseORM2Type(ORM2Type object) {
				return createORM2TypeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link edu.neumont.schemas.orm._2006._04.orm.root.DocumentRoot <em>Document Root</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link edu.neumont.schemas.orm._2006._04.orm.root.ORM2Type <em>ORM2 Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createORM2TypeAdapter() {
		return null;
	}
