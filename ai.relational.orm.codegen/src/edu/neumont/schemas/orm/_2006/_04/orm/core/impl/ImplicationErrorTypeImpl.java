...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Implication Error Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link edu.neumont.schemas.orm._2006._04.orm.core.impl.ImplicationErrorTypeImpl#getSetComparisonConstraint <em>Set Comparison Constraint</em>}</li>
 *   <li>{@link edu.neumont.schemas.orm._2006._04.orm.core.impl.ImplicationErrorTypeImpl#getSetConstraint <em>Set Constraint</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImplicationErrorTypeImpl extends ModelErrorImpl implements ImplicationErrorType {
	/**
	 ...
	 * @generated
	 */
	protected ImplicationErrorTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CorePackage.eINSTANCE.getImplicationErrorType();
	}
	...
	public NotificationChain basicSetSetComparisonConstraint(SetComparisonConstraintRef newSetComparisonConstraint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CorePackage.IMPLICATION_ERROR_TYPE__SET_COMPARISON_CONSTRAINT, oldSetComparisonConstraint, newSetComparisonConstraint);
	...
	public void setSetComparisonConstraint(SetComparisonConstraintRef newSetComparisonConstraint) {
		if (newSetComparisonConstraint != setComparisonConstraint) {
			...
			if (setComparisonConstraint != null)
				msgs = ((InternalEObject)setComparisonConstraint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CorePackage.IMPLICATION_ERROR_TYPE__SET_COMPARISON_CONSTRAINT, null, msgs);
			if (newSetComparisonConstraint != null)
				msgs = ((InternalEObject)newSetComparisonConstraint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CorePackage.IMPLICATION_ERROR_TYPE__SET_COMPARISON_CONSTRAINT, null, msgs);
			msgs = basicSetSetComparisonConstraint(newSetComparisonConstraint, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.IMPLICATION_ERROR_TYPE__SET_COMPARISON_CONSTRAINT, newSetComparisonConstraint, newSetComparisonConstraint));
	}
	...
	public NotificationChain basicSetSetConstraint(SetConstraintRef newSetConstraint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CorePackage.IMPLICATION_ERROR_TYPE__SET_CONSTRAINT, oldSetConstraint, newSetConstraint);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSetConstraint(SetConstraintRef newSetConstraint) {
		if (newSetConstraint != setConstraint) {
			...
			if (setConstraint != null)
				msgs = ((InternalEObject)setConstraint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CorePackage.IMPLICATION_ERROR_TYPE__SET_CONSTRAINT, null, msgs);
			if (newSetConstraint != null)
				msgs = ((InternalEObject)newSetConstraint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CorePackage.IMPLICATION_ERROR_TYPE__SET_CONSTRAINT, null, msgs);
			msgs = basicSetSetConstraint(newSetConstraint, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.IMPLICATION_ERROR_TYPE__SET_CONSTRAINT, newSetConstraint, newSetConstraint));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CorePackage.IMPLICATION_ERROR_TYPE__SET_COMPARISON_CONSTRAINT:
				return basicSetSetComparisonConstraint(null, msgs);
			case CorePackage.IMPLICATION_ERROR_TYPE__SET_CONSTRAINT:
